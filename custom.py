...
truthd_port=8800
version = "VERSION"
#either brain_wallet, or pubkey must be uncommented. They need 'quotes' around them. Do not use any spaces ' ', underscore is better '_'. If you want to mine, then you need to uncomment the first one. If you want to leave your computer unattended, then you should use the second one.
